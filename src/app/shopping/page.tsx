...
const initialCartItems = [
  ...
  { name: "Fresh Lime", price: 3.49, quantity: 1, image: "/product_img (1).png" },
  { name: "Pizza", price: 9.99, quantity: 4, image: "/product_img (2).png" },
  { name: "Chocolate Muffin", price: 4.49, quantity: 1, image: "/product_img (3).png" },
  { name: "Cheese Butter", price: 11.99, quantity: 3, image: "/product_img (4).png" },
];
    ...
    <div className="bg-white font-sans text-black">
      ...
      >
        ...
        <div className="w-full max-w-5xl flex flex-col justify-center items-center text-white text-center py-16">
          <p className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4">Shopping Cart</p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            <div className="flex items-center">
              ...
              <p className="ml-2 text-xl sm:text-2xl md:text-3xl text-[#FF9F0D]">Shopping cart</p>
            </div>
          </div>
        </div>
      </div>
